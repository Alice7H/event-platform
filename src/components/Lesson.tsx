...
export default function Lesson(props: ILessonsProps) {
  ...
  return (
    <Link to={isLessonAvailable ? `/event/lesson/${props.slug}` : '#'} 
      className={
        classNames('group', {'cursor-not-allowed': !isLessonAvailable,'cursor-pointer': isLessonAvailable})
      }
    >
      ...
      <div className={classNames('rounded border border-gray-500 p-4 mt-2 group-hover:border-green-500',{
        'bg-green-500 bubble': isActiveLesson,
        })}
      >
            ...
            <>
              ...
              <>
                ...
                'text-orange-500': !isActiveLesson,
                  ...
                  <span className={classNames('text-xs rounded px-2 py-[0.125rem] text-green-300 border font-bold',{
                    'border-white': isActiveLesson,
                    'border-green-300': !isActiveLesson,
                  })}>
                  {props.type === 'live' ? 'AO VIVO' : 'AULA PRÁTICA'}
